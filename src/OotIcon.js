        ...
        return (
            <div
                onClick={this.props.onClick ?
                    (e) => this.props.onClick(e, this.props.itemName, this.props.currentItem)
                    : null}
                className='iconDiv'
            >
                <div className='locationMenuIcon'>
                <img
                ...
                { 
                    this.props.itemName.includes('Small Key') ?
                        <span className='iconKeyText'>{keyMap[this.props.itemName.substring(11, this.props.itemName.length - 1)]}</span>
                        : null
                }
                { 
                    this.props.itemName.includes('Boss Key') ?
                        <span className='iconKeyText'>{keyMap[this.props.itemName.substring(10, this.props.itemName.length - 1)]}</span>
                        : null
                }
                { 
                    (this.props.itemName in songMap) ?
                        <span className='iconKeyText'>{songMap[this.props.itemName]}</span>
                        : null
                }
                </div>
            </div>
